...
<div class="navigation-links page-navigation">
	<span class="nav-next"><?php next_posts_link( '<span class="nav-meta">&laquo;</span> Стари публикации' ); ?></span>
	<span class="nav-previous"><?php previous_posts_link( 'Нови публикации <span class="nav-meta">&raquo;</span>' ); ?></span>
<!--END .navigation-links-->
</div>
<?php } ?>