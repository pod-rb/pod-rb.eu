...
?>
            ...
            <?php if ( have_posts() ) : ?>
            	<h1 class="page-title archive-title">Author Archives: <span class="author-title"><?php the_post(); echo $authordata->display_name; rewind_posts(); ?></span></h1>
				...
				<div id="post-0" class="<?php semantic_entries(); ?>">
					...
					<div class="entry-content">
						<p>Sorry, but <?php echo $authordata->user_nicename; ?> hasn't posted anything yet.</p>
						<?php get_search_form(); ?>
					<!--END .entry-content-->
					</div>
				<!--END #post-0-->
