...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>  
	...
	<div class="entry-container post-format">
        ...
        <header class="entry-header">
            ...
            <h3 class="entry-format"><a href="<?php echo esc_url( get_post_format_link( 'chat' ) ); ?>" title="<?php esc_attr_e( 'All Chat Posts', 'adventurous' ); ?>"><?php esc_attr_e( 'Chat', 'adventurous' ); ?></a></h3>
    	</header><!-- .entry-header -->  
