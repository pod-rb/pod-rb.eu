...
Plugin URI: http://altert.net/demo/openseadragon-zoom
Author URI: http://altert.net
Version: 1.4
Text Domain: zoom-openseadragon
Domain Path: /lang
Author:Alexey Tikhonov
Description: Zoom OpenSeadragon is an implementation of [OpenSeadragon](http://openseadragon.github.io/), an open-source, web-based viewer for high-resolution zoomable images, implemented in pure JavaScript, for desktop and mobile.
...
function zoom_openseadragon_settings_api_init() {
	...
	add_settings_section(
		...
		__('Zoom OpenSeadragon Options', 'zoom-openseadragon'),
...
// Zoom OpenSeadragon options on media settings
...
function zoom_openseadragon_setting_callback_function_replace_gallery() {
	echo '<input name="zoom_openseadragon_setting_replace_gallery" id="zoom_openseadragon_setting_replace_gallery" type="checkbox" value="1" class="code" ' . checked( 1, get_option( 'zoom_openseadragon_setting_replace_gallery' ), false ) . ' /> '.__('Replaces all galleries with Zoom OpenSeadragon galleries', 'zoom-openseadragon');
