 ...
 */
 class FlickrAlbumGallery {
	...
	public function fag_meta_box_form_function($post) {
		...
		<input required type="text" style="width:50%;" name="flickr-api-key" id="flickr-api-key" value="<?php echo $FAG_API_KEY; ?>"> <a title="Get your flickr account API Key"href="http://weblizar.com/get-flickr-api-key/" target="_blank"><?php _e("Get Your API Key", FAG_TEXT_DOMAIN ); ?></a>
		
		<p><?php _e("Enter Flickr Album ID", FAG_TEXT_DOMAIN ); ?></p>
		<input required type="text" style="width:50%;" name="flickr-album-id" id="flickr-album-id" value="<?php echo $FAG_Album_ID; ?>"> <a title="Get your flickr photo Album ID" href="http://weblizar.com/get-flickr-album-id/" target="_blank"><?php _e("Get Your Album ID", FAG_TEXT_DOMAIN ); ?></a>
		<br><br>		
...
function FAG_DOC_Menu_Function() {
	...
	add_submenu_page('edit.php?post_type=fa_gallery', 'Our Products', 'Our Products', 'administrator', 'fag-our-products', 'FAG_Our_Product_Page_Function');
	add_submenu_page('edit.php?post_type=fa_gallery', 'Recommendation', 'Recommendation', 'administrator', 'fag-recommendation', 'FAG_Recommendation_Function');
}
...
function FAG_DOC_Page_Function() {
	...
	wp_enqueue_style('font-awesome-5', FAG_PLUGIN_URL.'css/font-awesome-latest/css/fontawesome-all.min.css');
	...
	wp_enqueue_style('fag-bootstrap-min-css', FAG_PLUGIN_URL.'css/bootstrap.min.latest.css');
	require_once("flicker-album-gallery-help.php");
}

function FAG_Our_Product_Page_Function() {
	wp_enqueue_style('PGPP-boot-strap-admin', FAG_PLUGIN_URL.'css/bootstrap.min.latest.css');
	wp_enqueue_style('PGPP-font-awesome-5', FAG_PLUGIN_URL.'css/font-awesome-latest/css/fontawesome-all.min.css');
	require_once("our_product.php");
}

function FAG_Recommendation_Function() {
	wp_enqueue_style('recom2', FAG_PLUGIN_URL.'css/recom.css');
