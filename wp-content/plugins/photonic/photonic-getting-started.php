<div class="photonic-getting-started">
	...
	<p>
		...
		such as Flickr, SmugMug, Picasa, Google Photos etc. The following table tells you what you need for each provider, and provides you with links for how to show something using Photonic.
	</p>
	...
	<em>* The code for 500px.com exists in the plugin, however 500px.com has shut down its public API access from mid June 2018.</em>
