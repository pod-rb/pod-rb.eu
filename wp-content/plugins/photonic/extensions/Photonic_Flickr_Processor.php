...
class Photonic_Flickr_Processor extends Photonic_OAuth1_Processor {
	...
	function get_gallery_images($attr = array()) {
		global $photonic_flickr_allow_oauth, $photonic_flickr_oauth_done, $photonic_flickr_title_caption,
			   $photonic_flickr_thumb_size, $photonic_flickr_main_size, $photonic_flickr_tile_size, $photonic_flickr_video_size, $photonic_flickr_media;
...
//		$response = Photonic::http($query, 'GET', $params);
	 ...
	 * @return string
	 */
	function process_photos($photos, $owner = '', $parent = 'stream', $flickr_params, $short_code, $level_2_meta = array()) {
		...
		$photo_objects = $this->build_level_1_objects($photos, $owner, $flickr_params, $short_code);
	...
	function build_level_1_objects($photos, $owner = '', $flickr_params, $short_code) {
		$photo_objects = array();
		$video_size = in_array($this->library, array('colorbox', 'fancybox', 'fancybox2', 'fancybox3', 'featherlight', 'lightgallery', 'swipebox')) ? $short_code['video_size'] : 'Video Player';
